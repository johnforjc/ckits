...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">CKITS</a>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="text-white mt-0">Step 1</h3>
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="text-white mt-0">Step 2</h3>
            <p class="text-white-75 font-weight-light mb-5">Description</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="text-white mt-0">Step 3</h3>
            <p class="text-white-75 font-weight-light mb-5">Description</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <h3 class="text-white mt-0">Step 4</h3>
            <p class="text-white-75 font-weight-light mb-5">Description</p>
          </div>
        </div>
      </div>
  ...
  <section class="page-section bg-dark text-white">
    <div class="container text-center">
      <h2 class="mb-4">Come and Join Us!</h2>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
          ...
          <div>081 xxxxxxxxx</div>
        </div>
        <div class="col-lg-4 mr-auto text-center">
          <i class="fas fa-envelope fa-3x mb-3 text-muted"></i>
          
          <a class="d-block" href="mailto:contact@yourwebsite.com">website@website.com</a>
        </div>
      </div>
    </div>
  </footer>
